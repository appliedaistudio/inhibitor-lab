...
- **Change history** – Start with the [Inhibitor Service 3.1.7 release notes](docs/release-notes/3.1.7.md) for the latest real-time policy guidance, then review [release notes 3.1.6](docs/release-notes/3.1.6.md) for earlier notebook wording changes.
