...
**inhibitor-lab** is the open-source R&D space for integrating **Inhibitor Service 3.1.10** into agent-based systems. The audience is AI technologists who need defensible, real-time controls to keep autonomous agents from doing unsafe or wasteful work.
...
- **Change history** – Start with the [Inhibitor Service 3.1.10 release notes](docs/release-notes/3.1.10.md) for the latest agent intent guidance, then review [release notes 3.1.9](docs/release-notes/3.1.9.md) for earlier real-time context guidance.
