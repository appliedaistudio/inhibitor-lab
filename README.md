...
- **Supported controlled runtime trajectory benchmark** – review the [runtime trajectory guide](benchmarks/supported/runtime_trajectories/README.md) and validate its controlled scenarios with the runner dry-run.
