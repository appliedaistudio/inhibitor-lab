...
- **Change history** – Start with the [Inhibitor Service 3.1.8 release notes](docs/release-notes/3.1.8.md) for the latest guidance update, then review [release notes 3.1.7](docs/release-notes/3.1.7.md) for the earlier notebook launch links.
