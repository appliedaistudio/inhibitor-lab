...
**inhibitor-lab** is the open-source R&D space for integrating **Inhibitor Service 3.1.9** into agent-based systems. The audience is AI technologists who need defensible, real-time controls to keep autonomous agents from doing unsafe or wasteful work.
...
- **Change history** – Start with the [Inhibitor Service 3.1.9 release notes](docs/release-notes/3.1.9.md) for the latest real-time context guidance, then review [release notes 3.1.8](docs/release-notes/3.1.8.md) for earlier documentation changes.
