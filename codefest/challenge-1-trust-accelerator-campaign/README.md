# Challenge 1: Trust Accelerator Campaign (Digital Awareness)
...
Teams must submit all items below:
...
- **30 pts: Audience precision and relevance**
  - How well the campaign addresses real CTO/CIO trustworthy-AI priorities
- **25 pts: Digital innovation quality**
  - Novelty and practical value of the digital-first campaign approach
- **20 pts: Deliverable completeness and quality**
  - Clarity, polish, and judgeability of required artifacts
- **15 pts: Measurement rigor**
  - Strength and realism of KPI design, instrumentation, and success criteria
- **10 pts: Demo clarity and executive storytelling**
  - How effectively the team communicates impact to technical decision-makers
