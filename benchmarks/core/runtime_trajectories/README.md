...
The sole canonical fixture source is [`cases.json`](cases.json), a readable JSON array containing 16 cases. `runner.py --dry-run` loads and validates this same file, avoiding parallel fixture sources.
